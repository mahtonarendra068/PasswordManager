...
const Navbar = () => {
  return (
    <nav className='bg-slate-700 flex justify-between px-2 h-14 items-center gap-10 text-white sticky'>
      ...
      <ul >
        <li className='list-none flex  gap-5'>
            ...
            <span className='invert '> <a href="https://github.com/mahtonarendra068/nMahto-"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" color="#000000" fill="none">
